...
| `tools/` | Снятие и сверка контрольных срезов результатов классификации |
...
| `table_for_test.html` | Набор таблиц, на котором работают тесты эвристики |
...
Ожидается 154 пройденных теста. Файл `test_program.py` тестов не содержит:
это интерактивный аудит набора данных, который открывает в браузере отчёт по
